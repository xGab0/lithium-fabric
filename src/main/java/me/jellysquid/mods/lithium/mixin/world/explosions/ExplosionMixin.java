...
public abstract class ExplosionMixin {
    ...
    private void init(World world, Entity entity, DamageSource damageSource, ExplosionBehavior explosionBehavior, double d, double e, double f, float g, boolean bl, Explosion.DestructionType destructionType, ParticleEffect particleEffect, ParticleEffect particleEffect2, SoundEvent soundEvent, CallbackInfo ci) {
